...
if(file_exists(APPPATH.'config/app-config.php')){
    ...
    echo '<h1>Ice Whale not installed</h1>';
    echo '<p>1. To you use the automatic Ice Whale installed navigate to eq. http://yourdomain.com/ice/install</p>';
